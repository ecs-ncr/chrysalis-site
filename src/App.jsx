    ...
    >
        ...
        <div style={{ display: "flex", gap: "30px" }}>
          {[
            ...
            <motion.div
              ...
              style={{ cursor: "pointer", fontSize: "18px", opacity: 0.85 }}
              onClick={() =>
      ...
      >
        ...
        <motion.h2
          ...
          style={{ fontSize: "28px", marginTop: "20px", opacity: 0.85 }}
        >
      ...
      >
        ...
        <p style={{ marginTop: "20px", fontSize: "20px", lineHeight: "1.7" }}>
          A detailed list of rules for each category will be emailed to participants.
          <br />
